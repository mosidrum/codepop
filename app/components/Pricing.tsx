...
export const Pricing = () => (
  <section id="pricing" className="w-full py-16 px-4 sm:px-6 lg:px-8">
    <div className="max-w-6xl mx-auto">
      <h2 className="text-3xl sm:text-4xl font-bold text-center mb-4 bg-linear-to-r from-cyan-400 to-emerald-400 bg-clip-text text-transparent">
        Simple Pricing
      </h2>
        ...
        {plans.map((plan, index) => (
          <div
            ...
            className={`p-8 rounded-2xl backdrop-blur-sm border transition-all duration-300 ${
              plan.popular
                ? "bg-linear-to-br from-cyan-500/10 to-emerald-500/10 border-cyan-500/40 scale-105 shadow-xl shadow-cyan-500/10"
